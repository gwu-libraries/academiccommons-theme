...
//	(function ($) {
      ...
      if (jQuery(window).width() <= 640) {
        jQuery("#nav-research").html("<a href='/research' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/research');\">Research</a>");
        jQuery("#nav-collections").html("<a href='/collections' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/collections');\">Collections</a>");
        jQuery("#nav-services").html("<a href='/services' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/services');\">Services</a>");
        jQuery("#nav-news").html("<a href='/news-events' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/news');\">News</a>");
        jQuery("#nav-about").html("<a href='/about' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/about');\">About</a>");
        jQuery("#nav-hours").html("<a href='/hours' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/hours');\">Hours</a>");
        jQuery("#nav-lai").html("<a href='https://lai.gwu.edu' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/handheld/lai');\">Academic Innovation</a>");

        jQuery("#nav-eckles-research").html("<a href='/eckles/reference' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/research');\">Research</a>");
        jQuery("#nav-eckles-services").html("<a href='/eckles/services' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/services');\">Services</a>");
        jQuery("#nav-eckles-about").html("<a href='/eckles/about' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/about');\">About</a>");
        jQuery("#nav-eckles-academic-services").html("<a href='/eckles/academic-services-at-eckles' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/academic-services');\">Academic Svcs</a>");
        jQuery("#nav-eckles-flix").html("<a href='/eckles/eckles-flix' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/flix');\">Eckles Flix</a>");
        jQuery("#nav-eckles-hours").html("<a href='/eckles/hours' onClick=\"ga('send','event','primary-nav','/primary-nav/eckles/handheld/hours');\">Hours</a>");

        jQuery("#nav-virginia-research").html("<a href='virginia/research' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld/research');\">Research</a>");
        jQuery("#nav-virginia-collections").html("<a href='/virginia/collections' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld/collections');\">Collections</a>");
        jQuery("#nav-virginia-services").html("<a href='/virginia/services' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld/services');\">Services</a>");
        jQuery("#nav-virginia-news").html("<a href='/news-events' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld-ios/news');\">News</a>");
        jQuery("#nav-virginia-about").html("<a href='/virginia/about' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld/about');\">About</a>");
        jQuery("#nav-virginia-hours").html("<a href='/virginia/hours' onClick=\"ga('send','event','primary-nav','/primary-nav/virginia/handheld/hours');\">Hours</a>");

        jQuery("#nav-utlc-about").html("<a href='utlc/about' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/about');\">About</a>");
        jQuery("#nav-utlc-programs").html("<a href='/utlc/programs' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/programs');\">Programs</a>");
        jQuery("#nav-utlc-news-events").html("<a href='/utlc/news-events' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/news-events');\">News & Events</a>");
        jQuery("#nav-utlc-teaching").html("<a href='/utlc/teaching/teaching-guide' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/teaching');\">Teaching Guide</a>");
        jQuery("#nav-utlc-resources").html("<a href='/utlc/resources' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/resources');\">Resources</a>");
        jQuery("#nav-utlc-libraries").html("<a href='/' onClick=\"ga('send','event','primary-nav','/primary-nav/utlc/handheld/libraries');\">GW Libraries</a>");
...
//	<script type="text/javascript"><!--
	...
	// Define target of search
        ...
        AQB = "http://findit.library.gwu.edu/search";
